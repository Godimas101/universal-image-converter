    ...
    bool showProtoIngots = true;
        ...
        void DrawAllKnownSprite(ref MySpriteDrawFrame frame, ref Vector2 position)
        {
            try
            {
                ...
                SurfaceDrawer.WriteTextSprite(ref frame, headerPosition, surfaceData, $"Id [Ingots]", TextAlignment.LEFT, surfaceData.surface.ScriptForegroundColor);
